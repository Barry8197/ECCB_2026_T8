...
<div style="display: flex; flex-wrap: wrap; gap: 20px;">
  ...
  <div style="flex: 1; min-width: 250px; text-align: center;">
    <img src="profile_images/juliana_rodriguez.jpg" alt="Profile Photo 3" style="width: 100px; height: 100px; border-radius: 50%;">
...
<div style="display: flex; flex-wrap: wrap; gap: 20px;">
  ...
  <div style="flex: 1; min-width: 250px; text-align: center;">
    <img src="profile_images/Elisa_Castagnari.jpeg" alt="Profile Photo 1" style="width: 100px; height: 100px; border-radius: 50%;">
  ...
  <div style="flex: 1; min-width: 250px; text-align: center;">
    <img src="profile_images/emilia.png" alt="Profile Photo 2" style="width: 100px; height: 100px; border-radius: 50%;">
    <h3>Emilia Agasi</h3>
...
<div style="display: flex; flex-wrap: wrap; gap: 20px;">
  ...
  <div style="flex: 1; min-width: 250px; text-align: center;">
    <img src="profile_images/mariam.jpg" alt="Profile Photo 2" style="width: 100px; height: 100px; border-radius: 50%;">
  ...
  <div style="flex: 1; min-width: 250px; text-align: center;">
    <img src="profile_images/simona_doneva.png" alt="Profile Photo 3" style="width: 100px; height: 100px; border-radius: 50%;">
    <h3>Simona Doneva</h3>
